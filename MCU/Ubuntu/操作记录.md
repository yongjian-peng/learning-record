...
WEBKIT_DISABLE_DMABUF_RENDERER=1 GDK_BACKEND=x11 clash-verge
```
...
Y:\ARM\信步\固件\35AB6\android11\标品固件\标品android固件支持1920 1080 edp 信步镜像路径
```
...
![image-20260121181128665](./assets/image-20260121181128665.png)
