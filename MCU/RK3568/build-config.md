...
# Buildroot linux-5.10-gen-rkr7.3-dirty Configuration
#
...
BR2_LZCAT="lzip -d -c"
BR2_TAR_OPTIONS=""
BR2_DEFCONFIG="/home/yxw/myproject/rk356x_linux5.1/buildroot/configs/rockchip_rk3568_defconfig"
...
BR2_PACKAGE_BINUTILS_HAS_LIBSFRAME=y
# BR2_PACKAGE_BINUTILS_ENABLE_GOLD is not set
...
# BR2_PACKAGE_LINUX_TOOLS_PERF_SCRIPTS is not set
# BR2_PACKAGE_LINUX_TOOLS_PERF_TUI is not set
# BR2_PACKAGE_LINUX_TOOLS_PERF_NEEDS_HOST_PYTHON3 is not set
# BR2_PACKAGE_LINUX_TOOLS_SELFTESTS is not set
# BR2_PACKAGE_LINUX_TOOLS_USBTOOLS is not set
...
BR2_PACKAGE_ROCKCHIP_HAS_ISP2=y
# BR2_PACKAGE_PX30 is not set
# BR2_PACKAGE_RK3036 is not set
# BR2_PACKAGE_RK312X is not set
# BR2_PACKAGE_RK3288 is not set
# BR2_PACKAGE_RK3308 is not set
# BR2_PACKAGE_RK3326 is not set
# BR2_PACKAGE_RK3328 is not set
# BR2_PACKAGE_RK3358 is not set
# BR2_PACKAGE_RK3399 is not set
# BR2_PACKAGE_RK3399PRO is not set
# BR2_PACKAGE_RK3528 is not set
# BR2_PACKAGE_RK3562 is not set
BR2_PACKAGE_RK3566_RK3568=y
# BR2_PACKAGE_RK3588 is not set
...
# BR2_PACKAGE_COMMON_ALGORITHM is not set
BR2_PACKAGE_GSTREAMER1_ROCKCHIP=y
BR2_PACKAGE_LIBV4L_RKMPP=y
# BR2_PACKAGE_NPU_POWERCTRL is not set
# BR2_PACKAGE_NPU_POWERCTRL_COMBINE is not set
# BR2_PACKAGE_N4 is not set
# BR2_PACKAGE_RECOVERY is not set
# BR2_PACKAGE_RKNPU is not set
# BR2_PACKAGE_RKNPU_PCIE is not set
...
BR2_PACKAGE_RKSCRIPT_IODOMAIN_NOTICE=y
BR2_PACKAGE_RKSCRIPT_MOUNTALL=y
# BR2_PACKAGE_RKSCRIPT_BOOTANIM is not set
BR2_PACKAGE_RKSCRIPT_USB=y
BR2_PACKAGE_RKSCRIPT_USB_EXTRA_CONFIG=""
BR2_PACKAGE_RKSCRIPT_USB_ADBD=y
# BR2_PACKAGE_RKSCRIPT_USB_MTP is not set
# BR2_PACKAGE_RKSCRIPT_USB_ACM is not set
# BR2_PACKAGE_RKSCRIPT_USB_NTB is not set
# BR2_PACKAGE_RKSCRIPT_USB_UVC is not set
# BR2_PACKAGE_RKSCRIPT_USB_UAC1 is not set
# BR2_PACKAGE_RKSCRIPT_USB_UAC2 is not set
# BR2_PACKAGE_RKSCRIPT_USB_HID is not set
# BR2_PACKAGE_RKSCRIPT_USB_RNDIS is not set
# BR2_PACKAGE_RKSCRIPT_USB_UMS is not set
BR2_PACKAGE_RKTOOLKIT=y
# BR2_PACKAGE_RKTOOLKIT_STATIC is not set
# BR2_PACKAGE_RKUPDATE is not set
BR2_PACKAGE_RKWIFIBT=y
# BR2_PACKAGE_RKWIFIBT_STATIC is not set
...
# mali API features
#
# BR2_PACKAGE_ROCKCHIP_MALI_HAS_DUMMY is not set
...
# BR2_PACKAGE_ROCKCHIP_MALI_HAS_VULKAN is not set
...
# BR2_PACKAGE_RKADK is not set
# BR2_PACKAGE_TEE_USER_APP is not set
# BR2_PACKAGE_SLT_GPU_LIGHT is not set
...
BR2_PACKAGE_BUSYBOX_UNICODE_BYPASS=y
...
# BR2_PACKAGE_GST1_PLUGINS_GOOD_PLUGIN_XINGMUX is not set
# BR2_PACKAGE_GST1_PLUGINS_GOOD_PLUGIN_Y4M is not set

#
# plugins with external dependencies
#
# BR2_PACKAGE_GST1_PLUGINS_GOOD_ADAPTIVEMUX2 is not set
...
# BR2_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_OPENAL is not set
...
# BR2_PACKAGE_GST1_PLUGINS_BAD_PLUGIN_VA is not set
...
# BR2_PACKAGE_GST1_PLUGINS_BAD_ZXING is not set
...
# BR2_PACKAGE_STRACE_STATIC is not set
BR2_PACKAGE_STRESS=y
BR2_PACKAGE_STRESSAPPTEST=y
# BR2_PACKAGE_STRESSAPPTEST_STATIC is not set
...
# BR2_PACKAGE_NOTO_SANS_SC is not set
...
# BR2_PACKAGE_VKMARK is not set

#
# Graphic libraries
#
# BR2_PACKAGE_AML is not set
...
# BR2_PACKAGE_NEATVNC is not set
...
# BR2_PACKAGE_WESTON_VNC is not set
# BR2_PACKAGE_WESTON_PIPEWIRE is not set
...
# BR2_PACKAGE_EUDEV_STATIC is not set
...
BR2_PACKAGE_INPUT_EVENT_DAEMON_POWER_KEY=y
# BR2_PACKAGE_INPUT_EVENT_DAEMON_STATIC is not set
...
# BR2_PACKAGE_MEMTESTER_STATIC is not set
...
# BR2_PACKAGE_LIBODB_MYSQL is not set
...
# BR2_PACKAGE_ORACLE_MYSQL_SERVER is not set
...
# BR2_PACKAGE_LIBLOCKFILE_STATIC is not set
...
# BR2_PACKAGE_LIBDRM_STATIC is not set
...
# BR2_PACKAGE_LIBPNG_STATIC is not set
...
BR2_PACKAGE_WAYLAND_WITHOUT_EGL=y
...
# BR2_PACKAGE_LIBIDN2_BINARY is not set
...
# BR2_PACKAGE_LIBASIO is not set
...
# BR2_PACKAGE_LIBGLIB2_STATIC is not set
...
# BR2_PACKAGE_NCURSES_STATIC is not set
...
# BR2_PACKAGE_PCRE2_STATIC is not set
...
# BR2_PACKAGE_BLUEZ_TOOLS is not set
...
# BR2_PACKAGE_ANDROID_ADBD_STATIC is not set
BR2_PACKAGE_ANDROID_ADBD_TCP_PORT=0
# BR2_PACKAGE_ANDROID_ADBD_SECURE is not set
...
BR2_PACKAGE_COREUTILS_UNICODE_BYPASS=y
...
# BR2_PACKAGE_PROCPS_NG_STATIC is not set
BR2_PACKAGE_PROCRANK_LINUX=y
# BR2_PACKAGE_PROCRANK_LINUX_STATIC is not set
...
# BR2_PACKAGE_UTIL_LINUX_STATIC is not set
