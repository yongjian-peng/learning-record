...
bool AudioPlayerRandomButtonOnPress(ITUWidget* widget, char* param)
{
	audioPlayerScrollMediaFileListBox->mflistbox.randomPlay = atoi(param);
    return true;
}
