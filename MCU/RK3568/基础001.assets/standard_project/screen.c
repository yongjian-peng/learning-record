...
void ScreenOff(void)
{
    ...
    WifiMgr_Sta_Sleep_Disconnect();
    WifiMgr_Terminate();
#elif defined(CFG_NET_WIFI) && defined(CFG_NET_WIFI_SDIO)
    WifiMgr_Sta_Sleep_Disconnect();
    WifiMgr_Terminate();
#endif
