...
extern bool ImagePlayerScrollMediaFileListBoxOnLoad(ITUWidget* widget, char* param);
#endif
...
extern bool SettingHotspotOnEnter(ITUWidget* widget, char* param);
extern bool SettingHotspotRadioBoxOnPress(ITUWidget* widget, char* param);
...
ITUActionFunction actionFunctions[] =
{
...
#if CFG_LCD_WIDTH == 1280
	"ImagePlayerScrollMediaFileListBoxOnLoad", ImagePlayerScrollMediaFileListBoxOnLoad,
#endif
	...
	"SettingHotspotOnEnter", SettingHotspotOnEnter,
	"SettingHotspotRadioBoxOnPress", SettingHotspotRadioBoxOnPress,
    NULL, NULL
};
