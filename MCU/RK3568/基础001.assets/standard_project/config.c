...
void ConfigInit(void)
{
    ...
    // SSID
    strncpy(theConfig.ssid,iniparser_getstring(cfgIni, "wifi:ssid", ""),64);
    // Password
    strncpy(theConfig.password,iniparser_getstring(cfgIni,  "wifi:password", ""),256);
    // Security mode
    strncpy(theConfig.secumode,iniparser_getstring(cfgIni, "wifi:secumode", "NA"),3);
